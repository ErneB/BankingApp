...
echo "<td><a href='displaychangelog.php?rn=$J&change_File=$change_File'>Delete</a></td>";
for($I=0; $I < 3; $I++) {
...
echo "</body></html>";
$directory = "";
$files = glob($directory . "*database.xml");
echo "<form id='data_select' name='data_select' method='post' action='displaychangelog.php'>";
...
function delete_Process() {
    ...
    function update_XML_File_Process() {
        $change_Array = load_Array();
        require_once("item_data_class.php");
        $data_Changer = new item_data();
        $row_Count = count($change_Array) -1;
        for($I=0;$I < $row_Count; $I++) {
        ...
        $data_Changer = NULL;
        echo "Updated changes completed ✔";
        }
        // main section
